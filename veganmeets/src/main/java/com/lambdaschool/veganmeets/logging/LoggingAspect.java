package com.lambdaschool.veganmeets.logging;
...
{
    @Around(value = "@within(com.lambdaschool.veganmeets.logging.Loggable) || @annotation(com.lambdaschool.veganmeets.logging.Loggable)")
